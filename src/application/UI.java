...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc){
        try {
            ...
            // Recorta a String e da posição 1 em diante transforma em inteiro e armazena na variável
            return new ChessPosition(column, row);
        } catch(RuntimeException e){
            throw new InputMismatchException("Error reading input. Valid values from a1 to h8.");
        }
    }
